...
Foreach (${TestName} in ${LibraryTests} -split " ")
{
	...
	$Result = RunTestBinary ${TestExecutablesDirectory} "fcrypto_test_${TestName}"
...
Foreach (${TestName} in ${LibraryTestsWithInput} -split " ")
{
	...
	{
		$Result = RunTestBinaryWithInput ${TestExecutablesDirectory} "fcrypto_test_${TestName}" ${TestInput}

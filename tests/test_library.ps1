...
$LibraryTests = "error rc4_context serpent_context support"
...
Function RunTest
{
	...
	$TestExecutable = "${TestToolDirectory}\fcrypto_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libfcrypto"

...
#if !defined( _LIBFCRYPTO_EXTERN_H )
#define _LIBFCRYPTO_EXTERN_H

/* To export functions from the libfcrypto DLL define LIBFCRYPTO_DLL_EXPORT
 * To import functions from the libfcrypto DLL define LIBFCRYPTO_DLL_IMPORT
